...
import com.example.dddkj.ypth.Widget.DialogChooseImage;
import com.example.dddkj.ypth.common.Constant;
import com.example.dddkj.ypth.utils.RxPhotoUtils;
import com.example.dddkj.ypth.utils.RxSPUtils;
...
import static com.example.dddkj.ypth.Widget.DialogChooseImage.LayoutType.NO_TITLE;
import static com.example.dddkj.ypth.common.RequesURL.UPLOADPHOTO;
        ...
        switch (v.getId()) {
            ...
            case R.id.sex_rl:
                if (sex_tv.getText().toString().equals("男")) {
                    sex_tv.setText("女");
                } else if(sex_tv.getText().toString().equals("女")){
                    sex_tv.setText("男");
                }
                break;
...
//                RequestUpdateAvatar(new File(RxPhotoUtils.getRealFilePath(mContext, RxPhotoUtils.cropImageUri)));
            ...
            case UCrop.REQUEST_CROP://UCrop裁剪之后的处理
                if (resultCode == RESULT_OK) {
                    ...
                    OkGo.post(UPLOADPHOTO)//
                            .tag(this)//
                            .params("uid", MyApplication.getInstance().getUserid()) 		// 这里可以上传参数
                            .params("file",roadImageView(resultUri, ivAvatar))   // 可以添加文件上传
                            .execute(new StringCallback() {
                                ...
                                public void upProgress(long currentSize, long totalSize, float progress, long networkSpeed) {
                                    ...
                                    T.showShort(PersonalSettingActivity.this,"上传成功");
                                }
                            });
