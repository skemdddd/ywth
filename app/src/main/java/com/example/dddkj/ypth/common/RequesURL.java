package com.example.dddkj.ypth.common;
...
public class RequesURL {
    public static final String URL = "http://www.yipintonghang.com/";
    ...
    //    上传头像
    public static final String UPLOADPHOTO = URL + INDEX + "m=Customer&c=Users&a=userLogo";
    //    添加商品到购物车
